...
## For the commit hook and native [removed-harness-document] integration

When the user asks to install the post-commit auto-rebuild hook or wire graphify into a project's [removed-harness-document], see `references/hooks.md`.
