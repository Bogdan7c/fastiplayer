...
Main10/P010: FI pilot confirmed P010 zero-copy; VLC VA-API/OpenGL EGL-image/video-output path failed/fell back, so hardware pair NOT TESTED/profile unavailable. No equal smoothness, physical scanout, audible speaker PCM, whole-GPU total or quality-fixed claim. Historical quality issue is not closed and session 01+ did not run.
