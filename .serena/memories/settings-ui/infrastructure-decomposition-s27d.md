...
- Verification: settings-core tests, settings-derive generated schema + trybuild, rustiplayer-settings tests, rustiplayer-config strict registry/schema tests, app-egui settings_runtime tests, locked workspace check, strict clippy for settings crates, strict rustdoc, refactor guardrails.
