...
- Explicitly outside 11B: D53-D57 fast repeated concrete target preview/cursor (Session 11C), automatic Ended execution (Session 12), discovery wiring, config/schema, persistence/store, UI/hotkeys, and MPRIS backend wiring. Next allowed work is Session 11C only.
