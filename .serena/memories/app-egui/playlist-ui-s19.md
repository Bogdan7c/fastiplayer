...
## Toolbar and forms
- Playlist toolbar actions: async multi-file Add, inline URL Add/Cancel with Enter/Escape, Clear, six-key ascending/descending Sort menu, and explicit D80 “Перейти к текущему”. Repeat/shuffle remain in the main player controls and are intentionally not duplicated here; stop-after-current was removed from UI and code on 2026-07-18.
...
- D58 stop-after-current был полностью удалён 2026-07-18: нет toolbar action, interaction-model fields, controller delegation или pending-transition cancellation для этой команды. D69 Retry delegates to persistence scheduling and does not implement UI timers/backoff or block playlist editing.
