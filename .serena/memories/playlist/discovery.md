...
- Sessions 10A–10C are complete; app discovery jobs remain unwired. The next media-open integration scope is Session 10D; discovery must still not own app/controller policy.
