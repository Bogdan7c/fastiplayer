...
- `TransportOpenRequest` содержит exact provider/component/target, `MediaPresentation::{Vod,Live}`, source generation, redirect policy, ephemeral secrets и shared cancellation.
