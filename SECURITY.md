...
Rustiplayer is in active development / pre-alpha. There is no stable or LTS security-support promise. Reports affecting current `main` and the planned `v0.1.0-alpha.1` development release are welcome; fixes are expected on the current development line, without a guaranteed backport schedule or response SLA.

## Report a vulnerability privately

**Planned primary channel after public launch:** GitHub Private Vulnerability Reporting. It is planned for S12 and is not claimed to be enabled yet.

Once enabled, open the repository's [Security advisories](https://github.com/Bogdan7c/rustiplayer/security/advisories) and choose **Report a vulnerability**. GitHub describes the private report process in its [researcher guide](https://docs.github.com/en/code-security/how-tos/report-and-fix-vulnerabilities/report-privately).
