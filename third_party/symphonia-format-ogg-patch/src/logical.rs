...
impl LogicalStream {
                ...
                Ok(MapResult::StreamData { dur }) => {
                    ...
                    self.packets.push_back(
                        Packet::new_from_boxed_slice(page.header.serial, 0, dur, data)
                            .with_source_byte_offset(page.source_byte_offset),
                    );
                }
    ...
    pub fn inspect_page(&mut self, page: &Page<'_>) -> (u64, u64) {
        ...
        if !self.gapless {
            ...
            // delays.
            (
                page_start_ts.saturating_sub(delay),
                page_end_ts.saturating_sub(delay),
            )
        }
    }
