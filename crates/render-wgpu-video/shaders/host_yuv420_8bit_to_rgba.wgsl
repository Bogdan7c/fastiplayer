// Host-planar YUV420 8-bit to RGBA fragment shader.
...
fn fs_main(input: VertexOutput) -> @location(0) vec4<f32> {
    ...
    let sampled_u = textureSample(u_texture, planar_sampler, source_uv).r;
    let sampled_v = textureSample(v_texture, planar_sampler, source_uv).r;
