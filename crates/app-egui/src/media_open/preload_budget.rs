        ...
        match self {
            ...
            Self::Web(request) => {
                let request = match request.into_adapter() {
                    ...
                    super::web::WebMediaOpenAdapterView::NativeHds {
                        source,
                        intent,
                        mut settings,
                    } => {
                        ...
                        super::WebMediaOpenRequest::native_hds(source, intent, settings)
                    }
                    super::web::WebMediaOpenAdapterView::NativeSmooth {
                        source,
                        intent,
                        mut settings,
                    } => {
                        ...
                        super::WebMediaOpenRequest::native_smooth(source, intent, settings)
                    }
